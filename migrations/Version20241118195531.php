...
final class Version20241118195531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artists (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, picture VARBINARY(255) NOT NULL, content LONGTEXT NOT NULL, url LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE concert_details (id INT AUTO_INCREMENT NOT NULL, artist_id INT DEFAULT NULL, scene_id INT DEFAULT NULL, date_id INT DEFAULT NULL, schedule_id INT NOT NULL, UNIQUE INDEX UNIQ_E83CB72CB7970CF8 (artist_id), INDEX IDX_E83CB72C166053B4 (scene_id), INDEX IDX_E83CB72CB897366B (date_id), INDEX IDX_E83CB72CA40BC2D5 (schedule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE partners (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, name VARCHAR(255) NOT NULL, url LONGTEXT NOT NULL, logo VARBINARY(255) NOT NULL, INDEX IDX_EFEB5164C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
